...
// PATCHED (fp-extension): std::time::Instant::now() panics at runtime on
// wasm32-unknown-unknown. web-time is a drop-in replacement backed by
// performance.now() in the browser. See vendor/poke-engine/README.md.
